...
import { authenticatePaymentMerchant } from "../gRPC/controller/merchantAuth";
...
export const merchantAuthentication = async (
 ...
 return responseWithoutData(res, 401, false, "Invalid Authorization Token");
    ...
    const authResponse:MerchantAuthResponse = await authenticatePaymentMerchant(token, span, metadata);
